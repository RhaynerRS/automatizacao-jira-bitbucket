...
public class PullRequestFinalizarRepositorio: IPullRequestRepositorio
{
    private readonly HttpClient _httpClient;
    public PullRequestFinalizarRepositorio(IHttpClientFactory httpClientFactory)
    {
    ...
    {
        var idDestino = "31";
        if (IndoParaRelease(pullRequest.BranchDestino))
            idDestino = "2";
